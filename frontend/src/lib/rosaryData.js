...
export const mysteries = {
  Gozosos: {
    ...
    days: "Lunes y Sábado",
    list: [
      { title: "1º Misterio Gozoso", subtitle: "La Anunciación del Ángel a María", meditation: "Contemplamos cómo el ángel Gabriel anuncia a María que será Madre del Salvador." },
      { title: "2º Misterio Gozoso", subtitle: "La Visitación de María a su prima Santa Isabel", meditation: "María visita a su prima Isabel llevando a Jesús en su vientre." },
      { title: "3º Misterio Gozoso", subtitle: "El Nacimiento de Jesús en Belén", meditation: "Jesús nace en un pesebre, humilde y pobre." },
      { title: "4º Misterio Gozoso", subtitle: "La Presentación del Niño Jesús en el Templo", meditation: "María y José presentan al Niño al Señor." },
      { title: "5º Misterio Gozoso", subtitle: "El Niño Jesús perdido y hallado en el Templo", meditation: "María y José encuentran a Jesús enseñando en el Templo." },
    ],
  },
  Dolorosos: {
    ...
    list: [
      { title: "1º Misterio Doloroso", subtitle: "La Oración de Jesús en el Huerto", meditation: "Jesús ora en Getsemaní y suda sangre." },
      { title: "2º Misterio Doloroso", subtitle: "La Flagelación del Señor", meditation: "Jesús es azotado cruelmente en la columna." },
      { title: "3º Misterio Doloroso", subtitle: "La Coronación de Espinas", meditation: "Coronan a Jesús con espinas y se burlan de Él." },
      { title: "4º Misterio Doloroso", subtitle: "Jesús con la Cruz a cuestas camino del Calvario", meditation: "Jesús carga con la cruz por nosotros." },
      { title: "5º Misterio Doloroso", subtitle: "La Crucifixión y Muerte de Nuestro Señor", meditation: "Jesús muere en la cruz por nuestra salvación." },
    ],
  },
  Gloriosos: {
    ...
    list: [
      { title: "1º Misterio Glorioso", subtitle: "La Resurrección del Señor", meditation: "Cristo resucita victorioso al tercer día." },
      { title: "2º Misterio Glorioso", subtitle: "La Ascensión del Señor a los Cielos", meditation: "Jesús sube al cielo en cuerpo y alma." },
      { title: "3º Misterio Glorioso", subtitle: "La Venida del Espíritu Santo sobre los Apóstoles", meditation: "El Espíritu Santo desciende en lenguas de fuego." },
      { title: "4º Misterio Glorioso", subtitle: "La Asunción de la Santísima Virgen al Cielo", meditation: "María es llevada al cielo en cuerpo y alma." },
      { title: "5º Misterio Glorioso", subtitle: "La Coronación de María como Reina del Cielo", meditation: "María es coronada Reina de cielos y tierra." },
    ],
  },
  Luminosos: {
    ...
    days: "Jueves",
    list: [
      { title: "1º Misterio Luminoso", subtitle: "El Bautismo de Jesús en el Jordán", meditation: "El Padre proclama a Jesús como Hijo amado." },
      { title: "2º Misterio Luminoso", subtitle: "Las Bodas de Caná", meditation: "Por intercesión de María, Jesús realiza su primer milagro." },
      { title: "3º Misterio Luminoso", subtitle: "El Anuncio del Reino de Dios", meditation: "Jesús predica el Reino e invita a la conversión." },
      { title: "4º Misterio Luminoso", subtitle: "La Transfiguración del Señor", meditation: "Jesús se transfigura en el Tabor." },
      { title: "5º Misterio Luminoso", subtitle: "La Institución de la Eucaristía", meditation: "Jesús se entrega en la Eucaristía." },
    ],
  },
};
